...
def main(n_samples, output_directory, forcefield, data_filepath):
    ...
    vary_parameters_lhc(forcefield, n_samples, output_directory, smirks, np.asarray(param_range), nonuniform_ranges=False, absolute_ranges=False)
