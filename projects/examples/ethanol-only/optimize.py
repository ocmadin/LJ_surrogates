from LJ_surrogates.sampling.integrated_optimization import SurrogateSearchOptimizer

optimizer = SurrogateSearchOptimizer('openff-1-3-0.offxml','test-set-collection.json', port=8005)
