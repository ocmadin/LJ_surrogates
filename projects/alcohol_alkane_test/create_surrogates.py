...
path = '/home/owenmadin/storage/LINCOLN1/surrogate_modeling/alcohol_alkane/alkane_mixtures_only'
...
dataplex = collate_physical_property_data(path, smirks_types_to_change, 'test-set-collection-pent-hex-density.json')
