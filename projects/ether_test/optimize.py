...
path = '/home/owenmadin/storage/LINCOLN1/surrogate_modeling/mixture-only/mixture_full'
smirks_types_to_change = ['[#1:1]-[#6X4]', '[#6:1]', '[#6X4:1]', '[#8:1]', '[#8X2H0+0:1]', '[#8X2H1+0:1]']
forcefield = 'openff-1.0.0.offxml'
dataset_json = '/home/owenmadin/storage/LINCOLN1/surrogate_modeling/mixture-full-set.json'
device = 'cpu'
...
surrogate_objective = objective.forward(objective.flat_parameters)
simulation_objective = objective.simulation_objective(dataplex.property_measurements.values[3])
...
rmses = calculate_ff_rmses_surrogate(dataplex, params_to_simulate)
